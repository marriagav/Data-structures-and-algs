...
las clases: "heap","ipNode" y "bitacoraGraph". El cuarto archivo es "main.cpp" y es el archivo en dónde se inicializa el 
...
El resultado de main.cpp es la creación de dos archivos: "Grafo Bitácora.txt", que contiene a la lista de adyacencia con cada Ip, 
